...
With 1% data only
Epoch 200/200
 - 13s - loss: 0.0314 - acc: 0.9901
The score on test data is [0.062265669032779705, 0.9821164282190429] with only 1% of the data

WIth 10% data 
Epoch 200/200
 - 125s - loss: 0.0237 - acc: 0.9918
The score on final data is [0.0331765107254295, 0.9895354115301805] with only 10% of the data
"""
...
np.save('data/' + datafile + '.x1.npy', x)
